...
//        cell.titleLabel.accessibilityLanguage = self.dataSource.searchDomainURL.wmf_language;
...
//        cell.descriptionLabel.accessibilityLanguage = [self redirectMappingForResult:result] == nil ? self.dataSource.searchDomainURL.wmf_language : nil;
